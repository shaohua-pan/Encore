...
class CaptionsDataset(Dataset):
    ...
    def __init__(
        ...
        caption_prefix_path: str | None = None,
    ) -> None:
        """
        ...
        Args:
            ...
            caption_prefix_path: Optional prefix path to remove from caption paths
        """
        super().__init__()
        ...
        self.caption_prefix_path = caption_prefix_path
    ...
    def __getitem__(self, index: int) -> dict[str, Any]:
        ...
        caption_path = Path(self.output_paths[index])
        if self.caption_prefix_path is not None:
            output_path = str(caption_path.relative_to(self.caption_prefix_path))
        else:
...
def compute_captions_embeddings(  # noqa: PLR0913
    ...
    Args:
        ...
        caption_prefix_path: Optional to remove prefix path for caption files
    """
    ...
    dataset = CaptionsDataset(
        ...
        caption_prefix_path=caption_prefix_path,
    )
