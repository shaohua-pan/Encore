...
def preprocess_dataset(  # noqa: PLR0913
    ...
    with free_gpu_memory_context():
        ...
        compute_captions_embeddings(
            ...
            caption_prefix_path=video_prefix_path,
        )
...
def main(  # noqa: PLR0913
    ...
    with_reference_image: bool = typer.Option(
        default=False,
        help="Extract and encode reference images from video files",
    ),
    ...
    audio_indices_column: str | None = typer.Option(
        default=None,
        help="Column name containing audio indices (for audio-video training)",
    ),
