...
from ltx_trainer.training_strategies.text_to_video_encore import TextToVideoEncoreConfig, TextToVideoEncoreStrategy
...
TrainingStrategyConfig = TextToVideoConfig | VideoToVideoConfig | TextToVideoEncoreConfig
...
__all__ = [
    ...
    "TextToVideoConfig",
    "TextToVideoStrategy",
    "TextToVideoEncoreConfig",
    "TextToVideoEncoreStrategy",
    "TrainingStrategy",
...
def get_training_strategy(config: TrainingStrategyConfig) -> TrainingStrategy:
    ...
    match config:
        ...
        case TextToVideoEncoreConfig():
            strategy = TextToVideoEncoreStrategy(config)
